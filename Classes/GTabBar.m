...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
       ...
       tabBarHolder = [[UIView alloc] initWithFrame:CGRectMake(0, 428, 320, 480)];
    }
    else
    {
    ...
    UIImageView* view = [[UIImageView alloc] initWithImage: [UIImage imageNamed:@"BottomPanel.png"]];
    [tabBarHolder addSubview:view];
